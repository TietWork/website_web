...
import Challenge from '@/components/light/project-lpgVending/Challenge';
import Header from '@/components/light/project-lpgVending/Header';
import Solution from '@/components/light/project-lpgVending/Solution';
...
export default function LPGVending() {
  return (
    <body>
      <LoadingScreen />
      <Cursor />
