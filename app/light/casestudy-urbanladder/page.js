...
import Challenge from '@/components/light/CaseStudy-UrbanLadder/Challenge';
import Header from '@/components/light/CaseStudy-UrbanLadder/Header';
import Solution from '@/components/light/CaseStudy-UrbanLadder/Solution';
...
export default function UrbanLadder() {
  return (
    <body>
      <LoadingScreen />
      <Cursor />
