...
function Header() {
  ...
  return (
    <div
      ...
      style={{
        backgroundImage: `url('/light/assets/imgs/works/full/jobcard.jpg')`,
    ...
    >
      <div
        ...
        style={{
          textAlign: 'left',
          padding: '0 12px', // Adds responsive padding
          maxWidth: '1200px', // Ensures proper alignment with below content
        }}
      >
        <h1
          className=""
