              ...
              <div className="col-lg-7">
                <div className="text">
                  ...
                  <ul className="fz-18 mb-40" style={{ color: '#000' }}>
                    <li>
                      <strong>Operational Efficiency:</strong> Automation reduced manual work, improving the overall operational workflow.
                    </li>
                    <li>
                      <strong>Enhanced Patron Experience:</strong> Real-time seat filling visualization helped patrons make quicker and more informed decisions.
                    </li>
                    <li>
                      <strong>Increased Revenue:</strong> Optimized seat filling through real-time tracking resulted in better occupancy management and increased ticket sales.
                    </li>
                    <li>
                      <strong>Scalability:</strong> The solution can easily scale to accommodate additional screens and expand to other theatre locations.
                    </li>
                  </ul>
