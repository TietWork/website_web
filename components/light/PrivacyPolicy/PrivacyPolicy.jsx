            ...
            <div className="terms-content">
              ...
              <div className="term-section">
                ...
                <p>
                  ...
                  and disclosure of the personal data and other information that
                  we receive when they visit our websites or use any of our
                  products, services or applications (Platform).
                </p>
                <p>
                  By using the Platform or Services, you consent to the
                  collection, use and disclosure of your personal data as set
                  out in this Privacy Policy.
                </p>
                <p>
                  If you do not agree with this Privacy Policy, then we cannot
                  provide the Platform or Services to you, and you should stop
                  accessing the Platform. This Privacy Policy does not apply to
                  other websites to which we link (Third Party Website or Third
                  Party Websites).
                </p>
              </div>
              ...
              <div className="term-section">
                ...
                <ul>
                  <li>
                    ...
                    all of our users or specific groups or categories of users
                    that we combine together so that it can no longer identify
                    or reference an individual user.
                  </li>
                  <li>
                    <strong>Data Controller:</strong> Third Eye Info Technology,
                    the company responsible for the use and processing of
                    Personal Information.
                  </li>
                  <li>
                    <strong>Personal Data:</strong> Information relating to a
                    living individual who is or can be identified either from
                    that information or from that information in conjunction
              ...
              <div className="term-section">
                ...
                <ul>
                  <li>
                    Information you provide when purchasing products or
                    contacting customer support, such as name, phone number,
                    email, postal address, and payment information.
                  </li>
                  <li>
                    Information associated with your website visit, such as IP
                    address, mobile device identifier, and browsing data.
                  </li>
                  <li>
                    Information you provide when engaging with forms or social
                    media sharing, such as email addresses and product feedback.
                  </li>
                </ul>
              </div>
              ...
              <div className="term-section">
                ...
                <p>
                  ...
                  not want your device to share location information, you can
                  disable GPS or location-tracking functions in your device
                  settings.
                </p>
              </div>
              ...
              <div className="term-section">
                ...
                <ul>
                  <li>
                    To operate, protect, improve, and optimize the Platform and
                    services.
                  </li>
                  <li>
                    To send you support, service, and promotional messages.
                  </li>
                  <li>
                    To help create a trusted and safer environment for users.
                  </li>
                </ul>
              </div>
              ...
              <div className="term-section">
                ...
                <p>
                  ...
                  overseas. We also share your information with business
                  partners, affiliates, and third parties who assist in our
                  services.
                </p>
              </div>
              ...
              <div className="term-section">
                ...
                <p>
                  ...
                  information, but we cannot guarantee 100% security over the
                  Internet.
                </p>
              </div>
              ...
              <div className="term-section">
                ...
                <p>
                  ...
                  ThirdEye is not responsible for their privacy practices. We
